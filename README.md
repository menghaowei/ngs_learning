...
## 目录
   * [生物信息学交流QQ群 入群须知](#生物信息学交流qq群-入群须知)
      ...
      * [直播录像内容](#直播录像内容)
         ...
         * [第9次Live上机录像：20180804-如何使用R语言分析生物芯片数据](#第9次Live上机录像：20180804-如何使用R语言分析生物芯片数据)
...
### 第9次Live上机录像：20180804-如何使用R语言分析生物芯片数据
#### 网址
https://www.bilibili.com/video/av29802900
#### 主要内容
- 生物芯片处理流程及方法概览
- Illumina 450K甲基化芯片处理
- 背景介绍及技能要求
- Aroma项目介绍
- affy表达谱芯片的计算
- small RNA芯片分析及当遇到整体表达分布变化时的分析方法
- 如何从GEO下载高通量测序的原始数据
- Human Housekeeping gene的背景介绍
- - - - - - - - - - - - - - - - - - - - - -
